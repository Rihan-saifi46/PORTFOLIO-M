...
const Hero = () => {
  ...
  <div>
    ...
    <h2 className="text-6xl lg:text-[8vw] font-heading font-bold leading-[1] tracking-tight mt-3 mb-6">Web Developer <br/> & <span className='text-stroke'> Designer </span></h2>
      <GradientBtn text="Let's Talk" link="mailto:john@gmail.com" className="gradient-btn" />
    </div>

     <div className="star absolute -z-1 top-80 lg:top-32 right-[-35%] lg:right-[-9%] opacity-80">
